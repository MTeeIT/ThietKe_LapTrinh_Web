...
<body>
	...
	<?php 
		if(isset($_POST['btnThem'])){
			if(isset($_POST['nganh']) && isset($_POST['maLop']) && isset($_POST['tenLop'])){
				...
				$sql = "insert into tbl_lop values('$maLop','$tenLop','$nganh')";
	...
	<?php 
		if(isset($_GET['ma_xoa'])){
			...
			$sql = "Delete from tbl_lop where MaLop = '$maXoa'";
	...
	<?php 
		if(isset($_GET['ma_sua'])){
			$maSua = $_GET['ma_sua'];
			$sql = "select * from tbl_lop where MaLop = '$maSua'";
	...
	<?php 
		if(isset($_POST['btnSua'])){
			...
			$sql = "update tbl_lop set MaNG = '$nganh', TenLop = '$tenLop' where MaLop = '$maLop'";
	...
	<div class="container border" style="width: 500px;">
		<form action="frm_them_lop.php" method="post">
			...
			<div class="form-group text-right">
				...
				?>
					...
					<a href="frm_them_lop.php" class="btn btn-secondary">Hủy</a>
				<?php 	
					} else {
				?>
		...
		<tbody>
			...
			?>
				<tr>
					...
					<td><a href="frm_them_lop.php?ma_xoa=<?php echo $row['MaLop']; ?>" class="btn btn-danger" onclick="return confirm('Ban co muon xoa khong?')">Xóa</a>
					<a href="frm_them_lop.php?ma_sua=<?php echo $row['MaLop']; ?>" class="btn btn-success">Sửa</a></td>
				</tr>
			<?php 
					}
