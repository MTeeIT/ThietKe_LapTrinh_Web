...
FOR %%x IN ("D:\HK2N3\ThietKe_LapTrinh_Web\myWeb\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\HK2N3\ThietKe_LapTrinh_Web\myWeb\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\HK2N3\ThietKe_LapTrinh_Web\myWeb\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\HK2N3\ThietKe_LapTrinh_Web\myWeb\php\php.exe"
GOTO :INSTALLED
